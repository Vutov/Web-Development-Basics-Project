<div class="panel">
    ...
    <div class="row">
        ...
        \FTS\FormViewHelper::init()
            ...
            ->render(true);
        \FTS\FormViewHelper::init()
            ->initForm('/editor/category/rename', ['class' => 'form-group col-sm-4'], 'put')
    ...
    <div class="row">
        ...
        \FTS\FormViewHelper::init()
            ...
            ->render(true);
        \FTS\FormViewHelper::init()
            ->initForm('/editor/promotion/add', ['class' => 'form-group col-sm-4'], 'post')
            ...
            ->render(true);
        \FTS\FormViewHelper::init()
            ->initForm('/editor/promotion/remove', ['class' => 'form-group col-sm-4'], 'delete')
            ->initLabel()->setValue("Promotion name")->setAttribute('for', 'name')->create()
            ->initTextBox()->setName('name')->setAttribute('id', 'name')->setAttribute('class', 'form-control input-md')->create()
