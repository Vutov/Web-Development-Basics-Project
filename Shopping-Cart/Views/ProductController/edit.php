<div class="panel panel-primary">
    <div class="panel-body">
        ...
        ->initForm('/product/change/'. $this->_viewBag['body']->getId(), ['class' => 'form-group'], 'put')
        ...
        ->initTextBox()->setName('description')->setAttribute('id', 'description')->setAttribute('class', 'form-control
        input-md')
        ...
        ->initTextBox()->setName('quantity')->setAttribute('id', 'quantity')->setAttribute('class', 'form-control
        input-md')
        ->setAttribute('value', $this->_viewBag['body']->getQuantity())->create()
        ->initLabel()->setValue("Category")->setAttribute('for', 'category')->create()
        ->initTextBox()->setName('category')->setAttribute('id', 'category')->setAttribute('class', 'form-control
        input-md')
        ->setAttribute('value', $this->_viewBag['body']->getCategory())->create()
        ->initSubmit()->setAttribute('value', 'Change')->setAttribute('class', 'btn btn-primary btn-lg col-sm-4
        col-sm-offset-4')->create()
        ->render(); ?>
    </div>
</div>
